...
DJANGO_ADMIN_USER = env('DJANGO_ADMIN_USER')
...
OAUTH_REGISTER_CLIENT_ID = os.environ.get('OAUTH_REGISTER_CLIENT_ID')
OAUTH_REGISTER_CLIENT_SECRET = os.environ.get('OAUTH_REGISTER_CLIENT_SECRET')
OAUTH_REGISTER_REDIRECT_URI = os.environ.get('OAUTH_REGISTER_REDIRECT_URI')
