...
MIDDLEWARE = [
    ...
    # 'aouth.views.aouth.AouthLogoutInactivityMiddleware',
...
OAUTH_REGISTER_CLIENT_SECRET = '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'
OAUTH_REGISTER_REDIRECT_URI = 'https://localhost:443/aouth/aouth_callback_register/'

# 42 OAUTH LOGIN
# --------------

AOUTH_LOGIN_CLIENT_ID =  'u-s4t2ud-cecd1a52c9d51af27bc2daeefe882eda5dd05f725f7c6207b551e44720c37969'
OAUTH_LOGIN_CLIENT_SECRET = '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'
AOUTH_LOGIN_REDIRECT_URI = 'https://localhost:443/aouth/aouth_callback_login/'


# CRONJOBS = [
#     ('* * * * *', 'aouth.management.commands.check_user_inactivity.Command', f'>> {BASE_DIR}/logs/check_user_inactivity.log'),
# ]

CRON_CLASSES = [
    'aouth.cron.CheckUserInactivityCron',
    'aouth.cron.CheckUserUnverified'
]

# settings.py

# Set the time zone for your Django application
TIME_ZONE = 'UTC'  # or your preferred time zone, e.g., 'America/New_York'
